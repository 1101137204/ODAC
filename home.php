     ...
     <!-- <script>
      ...
      function deletecheck(){
        ...
        if(document.getElementById("inputdelpath").value=="south")
          ...
          //alert(document.getElementById("inputdel").value);
      ...
      <div class="overlay" id="overlay">
        <nav class="overlay-menu">
          <ul>
            ...
            <li><a data-toggle="modal" data-target="#recordModal" onclick="Nor_record(); Sou_record();">刊登紀錄</a></li>
            <li><a data-toggle="modal" data-target="#overModal" onclick="Sou_trade(); Nor_trade(); ">媒合紀錄</a></li> 
